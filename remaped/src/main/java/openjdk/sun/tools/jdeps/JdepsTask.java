...
package openjdk.sun.tools.jdeps;

import openjdk.sun.tools.jdeps.Analyzer.Type;
import static openjdk.sun.tools.jdeps.Analyzer.Type.*;
import static openjdk.sun.tools.jdeps.JdepsWriter.*;
...
class JdepsTask {
    ...
    private static class Options {
        ...
        String systemModulePath = com.itsaky.androidide.config.JavacConfigProvider.getJavaHome(); //System.getProperty("java.home");
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("openjdk.sun.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("openjdk.sun.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
                throw new InternalError("version.resource.missing");
            }
            try {
                jdkinternals = ResourceBundle.getBundle("openjdk.sun.tools.jdeps.resources.jdkinternals");
            } catch (MissingResourceException e) {
