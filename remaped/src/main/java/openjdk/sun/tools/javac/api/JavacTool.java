...
import openjdk.sun.tools.javac.main.Arguments;
import openjdk.sun.tools.javac.main.Option;
import openjdk.sun.tools.javac.file.BaseFileManager;
import openjdk.sun.tools.javac.file.CacheFSInfo;
import openjdk.sun.tools.javac.jvm.Target;
import openjdk.sun.tools.javac.util.ClientCodeException;
...
import openjdk.sun.tools.javac.util.PropagatedException;

/**
 * TODO: describe openjdk.sun.tools.javac.api.Tool
 *
...
public final class JavacTool implements JavaCompiler {
     ...
     * @see javx.tools.JavaCompiler
     * @see javx.tools.ToolProvider
     * @see #create
     */
    @Deprecated
    public JavacTool() {}
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return openjdk.sun.tools.javac.Main.compile(arguments, new PrintWriter(err, true));
    }
