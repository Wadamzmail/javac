...
package openjdk.sun.tools.javac.platform;
...
import javx.annotation.processing.Processor;
import javx.tools.ForwardingJavaFileObject;
...
import openjdk.sun.tools.javac.code.Source;
import openjdk.sun.tools.javac.code.Source.Feature;
...
public class JDKPlatformProvider implements PlatformProvider {
    ...
    static Path findCtSym() {
        String javaHome = com.itsaky.androidide.config.JavacConfigProvider.getJavaHome();//System.getProperty("java.home");
